      ...
      fetch('https://optimum-prime-lead-notifier.onrender.com/new-lead', {
        ...
        body: JSON.stringify({
          ...
          confirmation_message:
            `Hi ${form.name}! 🎉 Congratulations — you\'re all set for our webinar!\n\n` +
            `We\'re delighted to have you join us for:\n` +
            `*What\'s New in TallyPrime 7.1*\n\n` +
            `📅 *Date:* ${WEBINAR.date}\n` +
            `🕒 *Time:* ${WEBINAR.time}\n` +
            `📍 *Venue:* Online via Google Meet\n\n` +
            `🔗 *Your Join Link (save this):*\n${WEBINAR.joinLink}\n\n` +
            `We\'ll send you a reminder on the day. See you there! 🙌\n` +
            ...
            {state === 'success' ? (
              <div className="bg-white rounded-2xl border border-green-200 shadow-sm p-8 text-center h-full flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-slate-500 text-sm max-w-xs">
                  Congratulations! We've sent the Google Meet join link to your WhatsApp. We look forward to seeing you on <strong>{WEBINAR.date}</strong>.
                </p>
                <a
